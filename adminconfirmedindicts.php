...
error_reporting(0);
    ...
    $sql = " SELECT id,fullname,createdby,creator_organization,region,status FROM indictments WHERE status='confirmed'";
            ...
            <div class="list-of-victims-header">
                <div class="account-setting-select-setting">
                    <div class="info-setting-block-select" style="margin-top: 2rem;">
                        <h4 class="p-info-head"><a href="#">list of confirmed indictments</a></h4>
                    </div>
            ...
            <div class="list-of-victims-select-category">
                <div class="category-v-list">
                    ...
                    <div class="indicts-cat">
                        <p><a href="adminunconfirmedindicts.php">unconfirmed indicts</a></p>
                    </div>
                </div>
                <div class="category-v-list">
                    <!-- <div class="indicts-no">
                    ...
                    <div class="indicts-cat">
                        <p><a href="adminconfirmedindicts.php">confirmed indicts</a></p>
                    </div>
                </div>
            </div>
